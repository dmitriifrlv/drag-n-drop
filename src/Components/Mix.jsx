...
const operators = [
  {id: uuid(), content: 'Addition'},
  {id: uuid(), content: 'Subtraction'},
  {id: uuid(), content: 'Multiplication'},
  {id: uuid(), content: 'Division'}
]
const operands = [
  ...
  return(
    ...
    <div className="container">
      <div className="functionContainer">
        ...
        <Droppable droppableId='operators' key='operators' direction="horizontal">
              {
                (provided, snapshot) => {
                  return (
                    <div
        ...
        <Droppable droppableId='constructor' key='constructor' direction="horizontal">
              {
                (provided, snapshot) => {
                  return (
                    <div
